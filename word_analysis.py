...
def show_word(word_list):
    ...
    for word in word_list:
      for num in range(word[1]):
        text=text+' '+word[0]
    wc = WordCloud(width=1000, height=600, background_color="white", random_state=0, font_path='/content/drive/MyDrive/Colab Notebooks/MaruBuri-Regular.ttf') #맥
